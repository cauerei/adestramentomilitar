...
export function HeroSection() {
  return (
    <section 
      id="hero" 
      className="relative bg-primary py-12 text-primary-foreground sm:py-16 lg:py-20"
    >
          ...
          <div className="text-center">
            ...
            <div className="mt-8 flex flex-col items-center gap-4">
              <div className="flex items-baseline gap-4">
                <span className="text-xl font-medium text-primary-foreground/60 line-through">De R$147,00</span>
